            ...
            <div className="action-box">
              <div className="content-left">
                <ul>
                  ...
                  <li>
                    <svg aria-label="Comment" class="_ab6-" color="/8e8e8e" fill="/8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
                      <path
              ...
              <div className="content-medile"></div>
              <div className="content-end">
                <svg aria-label="Save" class="_ab6-" color="/8e8e8e" fill="/8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
                  <polygon
                    fill="none"
        ...
        <div className="post-items">
          ...
          <div className="post-content-con">
            ...
            <div className="content-box">
              ...
              <div className="post-text">
                <a href="/">ananda484</a> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur nesciunt, repudiandae at non sunt
                quasi eum sit c
              </div>
              <div className="view-comments">
                <a>view all comments</a>
