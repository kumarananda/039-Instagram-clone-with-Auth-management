  ...
  const handleUserRegister = async e => {
    ...
    try {
      if (!input.name || !input.email || !input.username || !input.password) {
        ...
        axios.post("http://localhost:5050/api/user/register", input).then(res => {
            ...
            {msg.status && (
              <>
                ...
                <h6 className={`alert alert-${msg.type}`}>
                  {" "}
                  <p> {msg.message}</p> {msg.pVerify && <Link to={"/user/mobile-verify"}>Go</Link>} <span onClick={alertClose}>X</span>
                </h6>{" "}
              </>
            )}
          </div>
          ...
          <div className="input-form">
            <form onSubmit={handleUserRegister} action="/">
              ...
              <div className="inp-box">
                <label htmlFor="name_fild" className={inpDcon.nameL}>
                  Full Name
                </label>
              ...
              <div className="inp-box">
                <label htmlFor="uname_fild" className={inpDcon.unameL}>
                  Username
                </label>
              ...
              <div className="inp-box">
                <label htmlFor="pass_fild" className={inpDcon.passL}>
                  Password
                </label>
                <input
              ...
              <p className="sign-up-msg">
                People who use our service may have uploaded your contact information to Instagram. <a href="/">Learn More</a> <br />
                <br /> {/*<div className='space-br' /> <div className='space-br' />*/}
