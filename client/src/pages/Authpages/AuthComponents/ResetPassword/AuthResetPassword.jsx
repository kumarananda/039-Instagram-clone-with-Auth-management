...
const AuthResetPassword = () => {
  ...
  const HandleResetPassword = async e => {
    ...
    if (!input.password || !input.confirmPass) {
      ...
      await axios
        .post("http://localhost:5050/api/user/reset-password", { password: input.password, token })
        .then(res => {
